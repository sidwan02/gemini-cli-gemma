  ...
  experimental: {
    ...
    properties: {
      ...
      gemmaSubagentSettings: {
        ...
        requiresRestart: true,
        default: {},
        description: 'Configuration for Gemma Subagent.',
        showInDialog: false,
        properties: {
          enabled: {
            type: 'boolean',
          ...
          maxNumTurns: {
            type: 'number',
            label: 'Gemma Max Num Turns',
            category: 'Experimental',
            requiresRestart: true,
            default: 15,
            description: 'Maximum number of turns for the Gemma agent.',
            showInDialog: true,
          },
          maxTimeMinutes: {
            type: 'number',
            ...
            requiresRestart: true,
            default: 5,
            description: 'Maximum time for the Gemma agent (in minutes).',
            showInDialog: false,
          },
          model: {
            type: 'string',
          ...
          host: {
            ...
            description: 'The Ollama host for the Gemma agent.',
            showInDialog: false,
          },
          useToolCallService: {
            type: 'boolean',
            label: 'Use Tool Call Service',
            category: 'Experimental',
            requiresRestart: true,
            default: false,
            description:
              'Enable the Tool Call Service for the Gemma agent (experimental).',
            showInDialog: false,
          },
        },
      },
      buildAndTestSettings: {
        type: 'object',
        label: 'Build and Test Settings',
        category: 'Experimental',
        requiresRestart: true,
        default: {},
        description: 'Configure the Build and Test subagent (experimental).',
        showInDialog: false,
        properties: {
          enabled: {
            type: 'boolean',
            label: 'Enable Build and Test Agent',
            category: 'Experimental',
            requiresRestart: true,
            default: false,
            description: 'Enable the Build and Test subagent.',
            showInDialog: false,
          },
          maxNumTurns: {
            type: 'number',
            ...
            default: 15,
            description:
              'Maximum number of turns for the Build and Test agent.',
            showInDialog: false,
          },
          maxTimeMinutes: {
            type: 'number',
            ...
            default: 20,
            description:
              'Maximum time for the Build and Test agent (in minutes).',
            showInDialog: false,
          },
          model: {
            type: 'string',
            ...
            requiresRestart: true,
            default: 'gemma3n:e4b',
            description: 'The model to use for the Build and Test agent.',
            showInDialog: false,
          },
          host: {
            type: 'string',
            ...
            requiresRestart: true,
            default: 'http://localhost:11434',
            description: 'The Ollama host for the Build and Test agent.',
            showInDialog: false,
          },
          useToolCallService: {
            type: 'boolean',
            ...
            default: false,
            description:
              'Enable the Tool Call Service for the Build and Test agent (experimental).',
            showInDialog: false,
          },
        },
      },
