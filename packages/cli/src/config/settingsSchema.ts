  ...
  experimental: {
    ...
    properties: {
      ...
      gemmaSubagentSettings: {
        ...
        requiresRestart: true,
        default: {},
        description: 'Configuration for Gemma.',
        showInDialog: false,
        properties: {
          enabled: {
            type: 'boolean',
          ...
          // TODO: is this model config correct? does it need to be ollama specific?
          model: {
            type: 'string',
            label: 'Model',
            category: 'Experimental',
      ...
      buildAndTestSettings: {
        type: 'object',
        label: 'BuildAndTestAgent Settings',
        category: 'Experimental',
        requiresRestart: true,
        default: {},
        description: 'Configuration for BuildAndTestAgent.',
        showInDialog: false,
        properties: {
          enabled: {
            type: 'boolean',
          ...
          maxTimeMinutes: {
            ...
            requiresRestart: true,
            default: 15,
            description: 'Maximum time for the agent (in minutes).',
            showInDialog: false,
          },
          // TODO: is this model config correct? does it need to be ollama specific?
          model: {
